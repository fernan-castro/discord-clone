...
export default function CreateServerForm(): JSX.Element {
    ...
    return (
        <dialog className="z-10 rounded-xl m-auto" ref={dialogRef}>
            ...
            <form method="dialog" className="flex flex-col space-y-2 px-6">
                ...
                <h2 className="max-h-64 labelTitle">
                    Add Users
                </h2>
            ...
            <div className="flex space-x-6 items-center justify-end p-6 bg-gray-200">
                ...
                <button type='submit'
                    ...
                    className={`bg-[#7289da] rounded py-2 px-4 text-white font-bold uppercase
